...
from wtforms import StringField, SelectField, SelectMultipleField, DateTimeField, BooleanField, ValidationError, HiddenField
...
class VenueForm(FlaskForm):
    ...
    facebook_link = StringField(
        'facebook_link', validators=[Optional(), URL(), Regexp('(?:(?:http|https):\/\/)?(?:www.)?facebook.com\/(?:(?:\w)*#!\/)?(?:pages\/)?(?:[?\w\-]*\/)?(?:profile.php\?id=(?=\d.*))?([\w\-]*)?', message="Please enter the facebook link using the correct format")]
    )
    website = StringField(
